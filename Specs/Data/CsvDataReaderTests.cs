...
namespace Xlnt.Data
{
	...
	public class CsvDataReaderTests
	{
		...
		public void GetValue_returns_fields_in_order(){
			...
			Verify.That(() => csv.GetValue(0).Equals("1"));
			Verify.That(() => csv.GetValue(1).Equals("2"));
			Verify.That(() => csv.GetValue(2).Equals("3"));
		}
		...
		public void should_support_multiple_data_rows() {
			...
			csv.Read();
			Verify.That(() => record["First"].Equals("1"));
			csv.Read();
			Verify.That(() => record["First"].Equals("2"));
		}
